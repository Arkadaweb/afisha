...
const PolicyPrivacyContent: FC<PropsWithChildren<any>> = ({
                                  pageData
                              }) => {

    console.log('pageData')
    console.log(pageData?.page_fields?.the_content)
    return (
        <MaxWithLayout>
            <div className="policy">
                <h1>{pageData?.title?.rendered}</h1>
                <p dangerouslySetInnerHTML={{__html: pageData?.page_fields?.the_content || ''}}/>
